-- Rehab & Rise — MySQL schema (v2: dashboards)
-- Run: mysql -u root -p < schema.sql

CREATE DATABASE IF NOT EXISTS rehab_rise
...
-- Availability (concrete public slots) --------------------------------------
...
-- Weekly availability template the coach edits -----------------------------
...
-- Members (coach is a member with is_admin = 1) ----------------------------
...
-- Training plans (one JSON doc per member) ----------------------------------
